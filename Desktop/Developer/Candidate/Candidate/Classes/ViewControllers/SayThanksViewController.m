...
#import "SayThanksViewController.h"

@interface SayThanksViewController ()

@end

@implementation SayThanksViewController

- (IBAction)proceedToQuestions:(id)sender {
    [self performSegueWithIdentifier:@"ontoQuestions" sender:nil];
}
